...
hm_diphoton_nmssm=TH1F("m_diphoton_nmssm","NMSSM", 250, 0,250)


#defining hists for b-jet abd b-dib

#Radion
hpt_b0=TH1F("pt_b_radion","Radion",75, 0., 150.)
heta_b0=TH1F("eta_b_radion","Radion", 50, -5., 5.)
hphi_b0=TH1F("phi_jet_radion","Radion", 50, -5., 5.)
heta_dib0=TH1F("eta_dib_radion","Radion", 50, -5., 5.)
hpt_dib0=TH1F("pt_dib_radion","Radion",75, 0., 150.)
hphi_dib0=TH1F("phi_dib_radion","Radion", 50, -5., 5.)
hm_dib0=TH1F("m_dib_radion","Radion", 250, 0, 250)

#Graviton
hpt_b2=TH1F("pt_b_graviton","Graviton",75, 0., 150.)
heta_b2=TH1F("eta_b_graviton","Graviton", 50, -5., 5.)
hphi_b2=TH1F("phi_jet_graviton","Graviton", 50, -5., 5.)
heta_dib2=TH1F("eta_dib_graviton","Graviton", 50, -5., 5.)
hpt_dib2=TH1F("pt_dib_graviton","Graviton",75, 0., 150.)
hphi_dib2=TH1F("phi_dib_graviton","Graviton", 50, -5., 5.)
hm_dib2=TH1F("m_dib_graviton","Graviton", 250, 0, 250)

#NMSSM
hpt_b_nmssm=TH1F("pt_b_nmssm","NMSSM",75, 0., 150.)
heta_b_nmssm=TH1F("eta_b_nmssm","NMSSM", 50, -5., 5.)
hphi_b_nmssm=TH1F("phi_jet_nmssm","NMSSM", 50, -5., 5.)
heta_dib_nmssm=TH1F("eta_dib_nmssm","NMSSM", 50, -5., 5.)
hpt_dib_nmssm=TH1F("pt_dib_nmssm","NMSSM",75, 0., 150.)
hphi_dib_nmssm=TH1F("phi_dib_nmssm","NMSSM", 50, -5., 5.)
hm_dib_nmssm=TH1F("m_dib_nmssm","NMSSM", 250, 0, 250)

#iterating over events
for e in events1:
    photons=e.getParticlesByIDs([22])
    jets=e.getParticlesByIDs([5,-5])
    p_phot=TLorentzVector(0,0,0,0)         #defining Lorentz-Vector for diphoton
    p_jet=TLorentzVector(0,0,0,0)          #defining Lorentz-Vector for dib
    for p in photons:
    ...
    for j in jets:
        ...
        heta_b0.Fill(j.eta)
        hphi_b0.Fill(j.phi)
    hpt_dib0.Fill(p_jet.Pt())
    heta_dib0.Fill(p_jet.Eta())
    hphi_dib0.Fill(p_jet.Phi())
    hm_dib0.Fill(p_jet.M())

for e in events2:
    photons=e.getParticlesByIDs([22])
    jets=e.getParticlesByIDs([5,-5])
    p_phot=TLorentzVector(0,0,0,0)
    p_jet=TLorentzVector(0,0,0,0)
    for p in photons:
        p_phot+=p.p4
    ...
    for j in jets:
        ...
        heta_b2.Fill(j.eta)
        hphi_b2.Fill(j.phi)
    hpt_dib2.Fill(p_jet.Pt())
    heta_dib2.Fill(p_jet.Eta())
    hphi_dib2.Fill(p_jet.Phi())
    hm_dib2.Fill(p_jet.M())
...
for e in events3:
    ...
    hpt_dib_nmssm.Fill(p_jet.Pt())
    heta_dib_nmssm.Fill(p_jet.Eta())
    hphi_dib_nmssm.Fill(p_jet.Phi())
    hm_dib_nmssm.Fill(p_jet.M())
...
hpt_photon0.SetTitle("Photon p_{t} (GeV) at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
heta_photon_nmssm.SetTitle("Photon #eta at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hphi_photon_nmssm.SetTitle("Photon #phi at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hpt_diphoton0.SetTitle("Diphoton p_{t} (GeV) at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
heta_diphoton_nmssm.SetTitle("Diphoton #eta at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hphi_diphoton_nmssm.SetTitle("Diphoton #phi (GeV) at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hm_diphoton_nmssm.SetTitle("Diphoton m (GeV) at M_{X}=300GeV")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hpt_b0.SetTitle("b p_{t} (GeV) at M_{X}=300GeV")
c.SaveAs("b_pt.root")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
heta_b_nmssm.SetTitle("b #eta at M_{X}=300GeV")
c.SaveAs("b_eta.root")
...
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hphi_b_nmssm.SetTitle("b #phi at M_{X}=300GeV")
c.SaveAs("b_phi.root")

hpt_dib_nmssm.Scale(1/hpt_dib_nmssm.GetEntries())
hpt_dib0.Scale(1/hpt_dib0.GetEntries())
hpt_dib2.Scale(1/hpt_dib2.GetEntries())
hpt_dib0.SetLineColor(600)
hpt_dib0.SetLineWidth(1)
hpt_dib0.SetMaximum(1.2*hpt_dib2.GetMaximum())
hpt_dib0.Draw("hist")
hpt_dib2.SetLineColor(418)
hpt_dib2.SetLineWidth(1)
hpt_dib2.Draw("hist&same")
hpt_dib_nmssm.SetLineColor(625)
hpt_dib_nmssm.SetLineWidth(1)
hpt_dib_nmssm.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hpt_dib0.SetTitle("Di-b p_{t} (GeV) at M_{X}=300GeV")
c.SaveAs("dib_pt.root")

heta_dib0.SetLineColor(600)
heta_dib0.SetLineWidth(1)
heta_dib2.SetLineColor(418)
heta_dib2.SetLineWidth(1)
heta_dib_nmssm.SetLineColor(625)
heta_dib_nmssm.SetLineWidth(1)
heta_dib_nmssm.Scale(1/heta_dib_nmssm.GetEntries())
heta_dib0.Scale(1/heta_dib0.GetEntries())
heta_dib2.Scale(1/heta_dib2.GetEntries())
heta_dib_nmssm.SetMaximum(1.2*heta_dib_nmssm.GetMaximum())
heta_dib_nmssm.Draw("hist")
heta_dib0.Draw("hist&same")
heta_dib2.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
heta_dib_nmssm.SetTitle("Di-b #eta at M_{X}=300GeV")
c.SaveAs("dib_eta.root")

hphi_dib0.SetLineColor(600)
hphi_dib0.SetLineWidth(1)
hphi_dib2.SetLineColor(418)
hphi_dib2.SetLineWidth(1)
hphi_dib_nmssm.SetLineColor(625)
hphi_dib_nmssm.SetLineWidth(1)
hphi_dib_nmssm.Scale(1/hphi_dib_nmssm.GetEntries())
hphi_dib0.Scale(1/hphi_dib0.GetEntries())
hphi_dib2.Scale(1/hphi_dib2.GetEntries())
hphi_dib_nmssm.SetMaximum(1.2*hphi_dib_nmssm.GetMaximum())
hphi_dib_nmssm.Draw("hist")
hphi_dib0.Draw("hist&same")
hphi_dib2.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hphi_dib_nmssm.SetTitle("Di-b #phi at M_{X}=300GeV")
c.SaveAs("dib_phi.root")

hm_dib0.SetLineColor(600)
hm_dib0.SetLineWidth(1)
hm_dib2.SetLineColor(418)
hm_dib2.SetLineWidth(1)
hm_dib_nmssm.SetLineColor(625)
hm_dib_nmssm.SetLineWidth(1)
hm_dib_nmssm.Scale(1/hm_dib_nmssm.GetEntries())
hm_dib0.Scale(1/hm_dib0.GetEntries())
hm_dib2.Scale(1/hm_dib2.GetEntries())
hm_dib_nmssm.SetMaximum(1.2*hm_dib_nmssm.GetMaximum())
hm_dib_nmssm.Draw("hist")
hm_dib0.Draw("hist&same")
hm_dib2.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
hm_dib_nmssm.SetTitle("Di-b m (GeV) at M_{X}=300GeV")
c.SaveAs("dib_mass.root")
