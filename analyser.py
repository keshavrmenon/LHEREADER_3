...
heta_photon_sm=TH1F("eta_photon_sm","SM", 10, -5, 5)
hphi_photon_sm=TH1F("phi_photon_sm","SM", 50, -5,5)
hpt_diphoton_sm=TH1F("pt_diphoton_sm","SM", 30, 0., 300.)
heta_diphoton_sm=TH1F("eta_diphoton_sm","SM", 50, -5, 5)
hphi_diphoton_sm=TH1F("phi_diphoton_sm","SM", 50, -5,5)
hm_diphoton_sm=TH1F("m_diphoton_sm","SM", 1000, 124.9, 125.1)

#Radion Model
hpt_photon0=TH1F("pt_photon_radion","Radion", 20, 0., 200)
heta_photon0=TH1F("eta_photon_radion","Radion", 10, -5, 5)
...
heta_photon2=TH1F("eta_photon_graviton","Graviton", 10, -5., 5.)
hphi_photon2=TH1F("phi_photon_graviton","Graviton", 50, -5,5)
hpt_diphoton2=TH1F("pt_diphoton_graviton","Graviton", 15, 0., 150)
heta_diphoton2=TH1F("eta_diphoton_graviton","Graviton", 10, -5., 5.)
...
heta_diphoton_nmssm=TH1F("eta_diphoton_nmssm","NMSSM", 10, -5., 5.)
...
heta_h_sm=TH1F("eta_h_sm","SM", 50, -5, 5)
hphi_h_sm=TH1F("phi_h_sm","SM", 50, -5,5)
hpt_hh_sm=TH1F("pt_dih_sm","SM", 50, 0., 200)
heta_hh_sm=TH1F("eta_hh_sm","SM", 50, -5, 5)
hphi_hh_sm=TH1F("phi_hh_sm","SM", 50, -5,5)
hm_hh_sm=TH1F("m_hh_sm","SM", 1000, 124.9, 125.1)

#Radion
hpt_h0=TH1F("pt_h_radion","Radion", 10, 0., 100)
heta_h0=TH1F("eta_h_radion","Radion", 10, -5., 5.)
hphi_h0=TH1F("phi_h_radion","Radion", 10, -5., 5.)
hpt_hh0=TH1F("pt_hh_radion","Radion", 50, 0., 200)
heta_hh0=TH1F("eta_hh_radion","Radion", 10, -5., 5.)
hphi_hh0=TH1F("phi_hh_radion","Radion", 10, -5., 5.)
hm_hh0=TH1F("m_hh_radion", "Radion", 1000, 290, 310)

#Graviton
hpt_h2=TH1F("pt_h_graviton","Graviton", 10, 0., 100)
heta_h2=TH1F("eta_h_graviton", "Graviton", 10, -5., 5.)
hphi_h2=TH1F("phi_h_graviton", "Graviton", 10, -5., 5.)
hpt_hh2=TH1F("pt_hh_graviton","Graviton", 50, 0., 200)
heta_hh2=TH1F("eta_hh_graviton", "Graviton", 10, -5., 5.)
hphi_hh2=TH1F("phi_hh_graviton", "Graviton", 10, -5., 5.)
hm_hh2=TH1F("m_hh_graviton", "Graviton", 1000, 290, 310)

#NMSSM
hpt_h_nmssm=TH1F("pt_h_nmssm","NMSSM", 10, 0., 100)
heta_h_nmssm=TH1F("eta_h_nmssm", "NMSSM", 10, -5., 5.)
hphi_h_nmssm=TH1F("phi_h_nmssm", "NMSSM", 10, -5., 5.)
hpt_y_nmssm=TH1F("pt_y_nmssm","NMSSM", 10, 0., 100)
heta_y_nmssm=TH1F("eta_y_nmssm", "NMSSM", 10, -5., 5.)
hphi_y_nmssm=TH1F("phi_y_nmssm", "NMSSM", 10, -5., 5.)
hpt_hy_nmssm=TH1F("pt_hy_nmssm","NMSSM", 20, 0., 200)
heta_hy_nmssm=TH1F("eta_hy_nmssm", "NMSSM", 10, -5., 5.)
hphi_hy_nmssm=TH1F("phi_hy_nmssm", "NMSSM", 10, -5., 5.)
