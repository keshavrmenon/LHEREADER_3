...
#SM
hpt_photon_sm=TH1F("pt_photon_sm","SM", 25, 0., 250)
heta_photon_sm=TH1F("eta_photon_sm","SM", 20, -5, 5)
hphi_photon_sm=TH1F("phi_photon_sm","SM", 20, -5,5)
hpt_diphoton_sm=TH1F("pt_diphoton_sm","SM", 30, 0., 300.)
heta_diphoton_sm=TH1F("eta_diphoton_sm","SM", 20, -5, 5)
hphi_diphoton_sm=TH1F("phi_diphoton_sm","SM", 20, -5,5)
hm_diphoton_sm=TH1F("m_diphoton_sm","SM", 1000, 124.9, 125.1)

#Radion Model
hpt_photon0=TH1F("pt_photon_radion","Radion", 20, 0., 200)
heta_photon0=TH1F("eta_photon_radion","Radion", 20, -5, 5)
hphi_photon0=TH1F("phi_photon_radion","Radion", 20, -5,5)
hpt_diphoton0=TH1F("pt_diphoton_radion","Radion", 15, 0., 150)
heta_diphoton0=TH1F("eta_diphoton_radion","Radion", 20, -5, 5)
hphi_diphoton0=TH1F("phi_diphoton_radion","Radion", 20, -5,5)
hm_diphoton0=TH1F("m_diphoton_radion","Radion", 1000, 124.9, 125.1)

#Graviton Model
hpt_photon2=TH1F("pt_photon_graviton","Graviton", 20, 0., 200)
heta_photon2=TH1F("eta_photon_graviton","Graviton", 20, -5., 5.)
hphi_photon2=TH1F("phi_photon_graviton","Graviton", 20, -5,5)
hpt_diphoton2=TH1F("pt_diphoton_graviton","Graviton", 15, 0., 150)
heta_diphoton2=TH1F("eta_diphoton_graviton","Graviton", 20, -5., 5.)
hphi_diphoton2=TH1F("phi_diphoton_graviton","Graviton", 20, -5,5)
hm_diphoton2=TH1F("m_diphoton_graviton","Graviton", 1000, 124.9, 125.1)

#NMSSM
hpt_photon_nmssm=TH1F("pt_photon_nmssm","NMSSM", 20, 0., 200)
heta_photon_nmssm=TH1F("eta_photon_nmssm","NMSSM", 20,-5., 5.)
hphi_photon_nmssm=TH1F("phi_photon_nmssm","NMSSM", 20, -5,5)
hpt_diphoton_nmssm=TH1F("pt_diphoton_nmssm","NMSSM",15,0.,150.)
heta_diphoton_nmssm=TH1F("eta_diphoton_nmssm","NMSSM", 20, -5., 5.)
hphi_diphoton_nmssm=TH1F("phi_diphoton_nmssm","NMSSM", 20, -5.,5.)
...
#SM
hpt_b_sm=TH1F("pt_b_sm","SM", 25, 0., 250)
heta_b_sm=TH1F("eta_b_sm","SM", 20, -5, 5)
hphi_b_sm=TH1F("phi_b_sm","SM", 20, -5,5)
hpt_bb_sm=TH1F("pt_bb_sm","SM", 30, 0., 300.)
heta_bb_sm=TH1F("eta_bb_sm","SM", 20, -5, 5)
hphi_bb_sm=TH1F("phi_bb_sm","SM", 20, -5,5)
hm_bb_sm=TH1F("m_bb_sm","SM", 1000, 124.9, 125.1)

#Radion
hpt_b0=TH1F("pt_b_radion","Radion", 20, 0., 200)
heta_b0=TH1F("eta_b_radion","Radion", 20, -5., 5.)
hphi_b0=TH1F("phi_b_radion","Radion", 20, -5., 5.)
heta_bb0=TH1F("eta_bb_radion","Radion", 10, -5., 5.)
hpt_bb0=TH1F("pt_bb_radion","Radion", 20, 0., 200)
hphi_bb0=TH1F("phi_bb_radion","Radion", 20, -5., 5.)
hm_bb0=TH1F("m_bb_radion","Radion", 1000, 124.9, 125.1)

#Graviton
hpt_b2=TH1F("pt_b_graviton","Graviton", 20, 0., 200)
heta_b2=TH1F("eta_b_graviton","Graviton", 20, -5., 5.)
hphi_b2=TH1F("phi_b_graviton","Graviton", 20, -5., 5.)
heta_bb2=TH1F("eta_bb_graviton","Graviton", 10, -5., 5.)
hpt_bb2=TH1F("pt_bb_graviton","Graviton", 20, 0., 200)
hphi_bb2=TH1F("phi_bb_graviton","Graviton", 20, -5., 5.)
hm_bb2=TH1F("m_bb_graviton","Graviton", 1000, 124.9, 125.1)

#NMSSM
hpt_b_nmssm=TH1F("pt_b_nmssm","NMSSM", 20, 0., 200)
heta_b_nmssm=TH1F("eta_b_nmssm","NMSSM", 20, -5., 5.)
hphi_b_nmssm=TH1F("phi_b_nmssm","NMSSM", 20, -5., 5.)
heta_bb_nmssm=TH1F("eta_bb_nmssm","NMSSM", 10, -5., 5.)
hpt_bb_nmssm=TH1F("pt_bb_nmssm","NMSSM", 20, 0., 200)
hphi_bb_nmssm=TH1F("phi_bb_nmssm","NMSSM", 20, -5., 5.)
hm_bb_nmssm=TH1F("m_bb_nmssm","NMSSM", 1000, 124.9, 125.1)

#defining Hists for Higgs, Y, HY, and X

#SM
hpt_h_sm=TH1F("pt_h_sm","SM", 50, 0., 200)
heta_h_sm=TH1F("eta_h_sm","SM", 20, -5, 5)
hphi_h_sm=TH1F("phi_h_sm","SM", 20, -5,5)
hpt_hh_sm=TH1F("pt_dih_sm","SM", 50, 0., 200)
heta_hh_sm=TH1F("eta_hh_sm","SM", 20, -5, 5)
hphi_hh_sm=TH1F("phi_hh_sm","SM", 20, -5,5)
hm_hh_sm=TH1F("m_hh_sm","SM", 1000, 124.9, 125.1)

#Radion
hpt_h0=TH1F("pt_h_radion","Radion", 10, 0., 100)
heta_h0=TH1F("eta_h_radion","Radion", 20, -5., 5.)
hphi_h0=TH1F("phi_h_radion","Radion", 20, -5., 5.)
hpt_hh0=TH1F("pt_hh_radion","Radion", 50, 0., 200)
heta_hh0=TH1F("eta_hh_radion","Radion", 20, -5., 5.)
hphi_hh0=TH1F("phi_hh_radion","Radion", 20, -5., 5.)
hm_hh0=TH1F("m_hh_radion", "Radion", 1000, 290, 310)

#Graviton
hpt_h2=TH1F("pt_h_graviton","Graviton", 10, 0., 100)
heta_h2=TH1F("eta_h_graviton", "Graviton", 20, -5., 5.)
hphi_h2=TH1F("phi_h_graviton", "Graviton", 20, -5., 5.)
hpt_hh2=TH1F("pt_hh_graviton","Graviton", 50, 0., 200)
heta_hh2=TH1F("eta_hh_graviton", "Graviton", 20, -5., 5.)
hphi_hh2=TH1F("phi_hh_graviton", "Graviton", 20, -5., 5.)
hm_hh2=TH1F("m_hh_graviton", "Graviton", 1000, 290, 310)

#NMSSM
hpt_h_nmssm=TH1F("pt_h_nmssm","NMSSM", 10, 0., 100)
heta_h_nmssm=TH1F("eta_h_nmssm", "NMSSM", 20, -5., 5.)
hphi_h_nmssm=TH1F("phi_h_nmssm", "NMSSM", 20, -5., 5.)
hpt_y_nmssm=TH1F("pt_y_nmssm","NMSSM", 10, 0., 100)
heta_y_nmssm=TH1F("eta_y_nmssm", "NMSSM", 20, -5., 5.)
hphi_y_nmssm=TH1F("phi_y_nmssm", "NMSSM", 20, -5., 5.)
hpt_hy_nmssm=TH1F("pt_hy_nmssm","NMSSM", 20, 0., 200)
heta_hy_nmssm=TH1F("eta_hy_nmssm", "NMSSM", 20, -5., 5.)
hphi_hy_nmssm=TH1F("phi_hy_nmssm", "NMSSM", 20, -5., 5.)
...
for e in events4:
    ...
    for p in photons:
        p_phot+=p.p4
        hpt_photon_sm.Fill(p.pt)
        heta_photon_sm.Fill(p.eta)
        hphi_photon_sm.Fill(p.phi)
    hpt_diphoton_sm.Fill(p_phot.Pt())
    heta_diphoton_sm.Fill(p_phot.Eta())
    hphi_diphoton_sm.Fill(p_phot.Phi())
    hm_diphoton_sm.Fill(p_phot.M())
    for j in bb:
        p_bb+=j.p4
        hpt_b_sm.Fill(j.pt)
        heta_b_sm.Fill(j.eta)
        hphi_b_sm.Fill(j.phi)
    hpt_bb_sm.Fill(p_bb.Pt())
    heta_bb_sm.Fill(p_bb.Eta())
    hphi_bb_sm.Fill(p_bb.Phi())
    hm_bb_sm.Fill(p_bb.M())
    for h in higgs:
        p_hh+=h.p4
        hpt_h_sm.Fill(h.pt)
        heta_h_sm.Fill(h.eta)
        hphi_h_sm.Fill(h.phi)
    hpt_hh_sm.Fill(p_hh.Pt())
    heta_hh_sm.Fill(p_hh.Eta())
    hphi_hh_sm.Fill(p_hh.Phi())
...
hpt_photon_sm.SetLineColor(800)
hpt_photon_sm.SetLineWidth(1)
...
heta_photon_nmssm.GetXaxis().SetTitle("#eta(#gamma)")
...
hphi_photon_nmssm.GetXaxis().SetTitle("#phi(#gamma)")
...
hpt_diphoton_sm.SetLineColor(800)
hpt_diphoton_sm.SetLineWidth(1)
hpt_diphoton_sm.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
...
heta_diphoton_nmssm.GetXaxis().SetTitle("#eta(#gamma #gamma)")
...
hphi_diphoton_nmssm.GetXaxis().SetTitle("#phi(#gamma #gamma)")
...
hm_diphoton_nmssm.GetXaxis().SetTitle("#phi(#gamma #gamma)")
...
hpt_bb_sm.Scale(1/hpt_bb_sm.GetEntries())
...
hpt_bb_sm.SetLineColor(800)
hpt_bb_sm.SetLineWidth(1)
hpt_bb_sm.Draw("hist&same")
l=c.BuildLegend(0.75, 0.4, 0.9, 0.5)
...
hpt_h0.SetMaximum(1.2*hpt_h2.GetMaximum())
hpt_h0.Draw("hist")
...
hpt_diphoton_sm.SetTitle("p_{T}(#gamma #gamma) in Standard Model")
hpt_diphoton_sm.GetXaxis().SetTitle("p_{T}[GeV]")
hpt_diphoton_sm.Draw("hist")
c.SaveAs("pt_diphoton_sm.root")

hpt_bb_sm.SetTitle("p_{T}(bb) in Standard Model")
hpt_bb_sm.GetXaxis().SetTitle("p_{T}[GeV]")
hpt_bb_sm.Draw("hist")
c.SaveAs("pt_bb_sm.root")
'''
f.Write()
